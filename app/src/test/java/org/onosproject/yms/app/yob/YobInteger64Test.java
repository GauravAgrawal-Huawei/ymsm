    ...
    */
    ...
    public void validateYangObject(YangRequestWorkBench defaultYdtBuilder) {
        ...
        try {
            ...
            assertEquals("-9223372036854775808", negInt.get(yangObject).toString());
            Field posIntField = yangObject.getClass().getDeclaredField("posInt");
            posIntField.setAccessible(true);
            assertEquals("9223372036854775807", posIntField.get(yangObject).toString());
            ...
            assertEquals("18446744073709551615", maxUint.get(yangObject).toString());
            Field minUintWithRange = yangObject.getClass().getDeclaredField("minUintWithRange");
