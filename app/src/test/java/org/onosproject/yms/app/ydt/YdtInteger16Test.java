...
public class YdtInteger16Test {
    ...
    */
    ...
    public void positiveTest() throws IOException {
        YangRequestWorkBench ydtBuilder = YdtTestUtils.integer16Ydt();
    ...
    */
    ...
    public void negativeTest() throws IOException {
        String appName = "org.onosproject.yang.gen.v1.ydt.integer16" +
                ".rev20160524.Integer16Service";
        YangRequestWorkBench ydtBuilder = YdtTestUtils
                .getydtBuilder("builtInType", "integer16",
        ...
        ydtBuilder = YdtTestUtils.getydtBuilder(
                "builtInType", "integer16", "ydt.integer16", appName);
        try {
        ...
        ydtBuilder = YdtTestUtils.getydtBuilder(
                "builtInType", "integer16", "ydt.integer16", appName);
        try {
            ydtBuilder.addLeaf("negInt", null, "-32769");
        } catch (Exception e) {
            assertThat(true, is(e.getMessage().contains(
                    "YANG file error : Input value \"" + "-32769"
                            + "\" is not a valid int16.")));
        }
        ...
        ydtBuilder = YdtTestUtils.getydtBuilder(
                "builtInType", "integer16", "ydt.integer16", appName);
        try {
            ydtBuilder.addLeaf("posInt", null, "32768");
        } catch (Exception e) {
            assertThat(true, is(e.getMessage().contains(
                    "YANG file error : Input value \""
        ...
        ydtBuilder = YdtTestUtils.getydtBuilder(
                "builtInType", "integer16", "ydt.integer16", appName);
        try {
            ydtBuilder.addLeaf("minUInt", null, "-32769");
        } catch (Exception e) {
            assertThat(true, is(e.getMessage().contains(
                    "YANG file error : -32769 is lesser than minimum " +
                            "value 0.")));
        }
        ...
        ydtBuilder = YdtTestUtils.getydtBuilder(
                "builtInType", "integer16", "ydt.integer16", appName);
        try {
            ydtBuilder.addLeaf("maxUInt", null, "65536");
        } catch (Exception e) {
            assertThat(true, is(e.getMessage().contains(
                    "YANG file error : 65536 is greater than " +
                            "maximum value 65535.")));
        }
    ...
    public void negative1Test() throws IOException {
        ...
        ydtBuilder.addChild("multiRangeValidation", null);
        try {
            ydtBuilder.addLeaf("revInteger", null, "-32769");
        } catch (Exception e) {
            assertThat(true, is(e.getMessage().contains(
                    "YANG file error : Input value \"" + "-32769" + "\" " +
                            "is not a valid int16.")));
    ...
    public void negative2Test() throws IOException {
        ...
        try {
            ...
            assertThat(true, is(e.getMessage().contains(
                    "YANG file error : Input value \"" + "32768" + "\" " +
                            "is not a valid int16.")));
        }
        ...
        ydtBuilder.addChild("multiRangeValidation", null);
        try {
            ydtBuilder.addLeaf("revUnInteger", null, "-32769");
        } catch (Exception e) {
            assertThat(true, is(e.getMessage().contains(
                    "YANG file error : -32769 is lesser than minimum " +
                            "value 0.")));
        ...
        ydtBuilder.addChild("multiRangeValidation", null);
        try {
            ydtBuilder.addLeaf("revUnInteger", null, "65536");
        } catch (Exception e) {
            assertThat(true, is(e.getMessage().contains(
                    "YANG file error : 65536 is greater than maximum " +
                            "value 65535" + ".")));
        }
    }
}
