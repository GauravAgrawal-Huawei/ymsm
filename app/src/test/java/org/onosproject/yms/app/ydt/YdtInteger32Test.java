...
public class YdtInteger32Test {
    ...
    */
    ...
    public void negativeTest() throws IOException {
        ...
        YangRequestWorkBench defaultYdtBuilder = YdtTestUtils.getDefaultYdtBuilder("builtInType", "integer32",
        ...
        defaultYdtBuilder = YdtTestUtils.getDefaultYdtBuilder("builtInType", "integer32", "ydt.integer32", appName);
        try {
        ...
        defaultYdtBuilder = YdtTestUtils.getDefaultYdtBuilder("builtInType", "integer32", "ydt.integer32", appName);
        try {
            defaultYdtBuilder.addLeaf("negInt", null, "-2147483649");
        } catch (final Exception e) {
            assertThat(true, is(e.getMessage().contains("YANG file error : Input value \"" + "-2147483649"
                    + "\" is not a valid int32.")));
        }

        defaultYdtBuilder = YdtTestUtils.getDefaultYdtBuilder("builtInType", "integer32", "ydt.integer32", appName);
        try {
            defaultYdtBuilder.addLeaf("posInt", null, "2147483648");
        } catch (final Exception e) {
            assertThat(true, is(e.getMessage().contains("YANG file error : Input value \"" + "2147483648"
                    + "\" is not a valid int32.")));
        }

        defaultYdtBuilder = YdtTestUtils.getDefaultYdtBuilder("builtInType", "integer32", "ydt.integer32", appName);
        try {
            defaultYdtBuilder.addLeaf("minUInt", null, "-2147483649");
        } catch (final Exception e) {
            assertThat(true, is(e.getMessage().contains("YANG file error : -2147483649 " +
                    "is lesser than minimum value 0.")));
        }

        defaultYdtBuilder = YdtTestUtils.getDefaultYdtBuilder("builtInType", "integer32", "ydt.integer32", appName);
        try {
            defaultYdtBuilder.addLeaf("maxUInt", null, "4294967296");
        } catch (final Exception e) {
            assertThat(true, is(e.getMessage().contains("YANG file error : 4294967296 " +
    ...
    public void negative1Test() throws IOException {
        ...
        defaultYdtBuilder.addChild("multiRangeValidation", null);
        try {
            defaultYdtBuilder.addLeaf("revInteger", null, "-2147483649");
        } catch (final Exception e) {
            assertThat(true, is(e.getMessage().contains("YANG file error : Input value \"" + "-2147483649"
                    + "\" " + "is not a valid int32.")));
        }
    ...
    public void negative2Test() throws IOException {
        ...
        try {
            ...
            assertThat(true, is(e.getMessage().contains("YANG file error : Input value \"" + "65536" + "\" " +
                    "is not a valid int32.")));
        }
        ...
        defaultYdtBuilder.addChild("multiRangeValidation", null);
        try {
            defaultYdtBuilder.addLeaf("revUnInteger", null, "-2147483649");
        } catch (final Exception e) {
            assertThat(true, is(e.getMessage().contains("YANG file error : -2147483649 " +
                    "is lesser than minimum value 0.")));
        }
        ...
        defaultYdtBuilder.addChild("multiRangeValidation", null);
        try {
            defaultYdtBuilder.addLeaf("revUnInteger", null, "4294967296");
        } catch (final Exception e) {
            assertThat(true, is(e.getMessage().contains("YANG file error : 4294967296 is greater than maximum value " +
                    "4294967295" +
                    ".")));
        }
