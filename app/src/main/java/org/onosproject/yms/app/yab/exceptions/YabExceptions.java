 ...
 */
public class YabExceptions extends RuntimeException {
     ...
     */
    public YabExceptions(String message) {
        super(message);
    }
     ...
     */
    public YabExceptions(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause underlying cause of the error
     */
    public YabExceptions(final Throwable cause) {
        super(cause);
    }
}
