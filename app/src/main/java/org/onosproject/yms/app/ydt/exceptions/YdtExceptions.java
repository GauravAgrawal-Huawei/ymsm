 ...
 */
public class YdtExceptions extends RuntimeException {
     ...
     */
    public YdtExceptions(String message) {
        super(message);
    }
     ...
     */
    public YdtExceptions(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause underlying cause of the error
     */
    public YdtExceptions(final Throwable cause) {
        super(cause);
    }
}
