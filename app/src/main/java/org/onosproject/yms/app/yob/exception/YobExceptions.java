...
public class YobExceptions
    ...
    /**
     * Creates a new YOB exception.
     */
    public YobExceptions() {
        super();
    }
    ...
    /**
     * Creates a new YOB exception from given message and cause.
     *
     * @param message the detail of exception in string
     * @param cause   underlying cause of the error
     */
    public YobExceptions(final String message, final Throwable cause) {
        super(message, cause);
    }

    /**
     * Creates a new YOB exception from cause.
     *
     * @param cause underlying cause of the error
     */
    public YobExceptions(final Throwable cause) {
        super(cause);
    }
}
