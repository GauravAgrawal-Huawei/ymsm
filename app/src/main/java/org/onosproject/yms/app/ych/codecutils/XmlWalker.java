...
/**
 * Abstraction of an entity which provides interfaces for xml walk. This interface serve
 * as common tools for anyone who needs to parse the xml node with depth-first algorithm.
 */
