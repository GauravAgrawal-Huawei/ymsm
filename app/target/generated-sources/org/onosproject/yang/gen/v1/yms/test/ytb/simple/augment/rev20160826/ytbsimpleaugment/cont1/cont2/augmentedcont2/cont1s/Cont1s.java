...
public interface Cont1s {
    ...
    interface Cont1sBuilder {
        ...
        /**
         * Returns the builder object of fine.
         *
         * @param fine value of fine
         * @return builder object of fine
         */
        Cont1sBuilder fine(String fine);
         ...
         */
        Cont1sBuilder selectLeaf(LeafIdentifier leaf);
