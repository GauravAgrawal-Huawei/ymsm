...
/**
 * Abstraction of an entity which represents the functionality of ymsIetfNetwork.
 */
public interface YmsIetfNetwork {
    ...
    /**
     * Checks if the passed YmsIetfNetwork maps the content match query condition.
     *
     * @param ymsIetfNetwork ymsIetfNetwork being passed to check for content match
     * @param isSelectAllSchemaChild is select all schema child
     * @return match result
     */
    YmsIetfNetwork processSubtreeFiltering(YmsIetfNetwork ymsIetfNetwork, boolean isSelectAllSchemaChild);
}
