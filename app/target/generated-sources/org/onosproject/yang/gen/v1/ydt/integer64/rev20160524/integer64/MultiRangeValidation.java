...
public interface MultiRangeValidation {
    ...
    interface MultiRangeValidationBuilder {
         ...
         */
        MultiRangeValidationBuilder integer(long integer);
         ...
         */
        MultiRangeValidationBuilder unInteger(BigInteger unInteger);
         ...
         */
        MultiRangeValidationBuilder revInteger(long revInteger);
         ...
         */
        MultiRangeValidationBuilder revUnInteger(BigInteger revUnInteger);
