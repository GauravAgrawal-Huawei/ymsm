...
package org.onosproject.yang.gen.v1.yms.test.ytb.simple.augment.rev20160826.ytbsimpleaugment.cont1;
...
public class DefaultCont2 implements Cont2 {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(fine, onosYangNodeOperationType);
    }
    ...
    private boolean processLeafSubtreeFiltering(Cont2 appInstance, Cont2Builder subTreeFilteringResultBuilder,
            Boolean isAnySelectOrContainmentNode, boolean isSelectAllSchemaChild) {
        if (getValueLeafFlags().get(LeafIdentifier.FINE.getLeafIndex())) {
            if (appInstance.fine() == null || !(fine().equals(appInstance.fine()))) {
                return false;
            } else {
                subTreeFilteringResultBuilder.fine(appInstance.fine());
            }
        } else if (getSelectLeafFlags().get(LeafIdentifier.FINE.getLeafIndex()) || isSelectAllSchemaChild) {
    ...
    public static class Cont2Builder implements Cont2.Cont2Builder {
        ...
        @Override
        public Cont2Builder fine(String fine) {
            getValueLeafFlags().set(LeafIdentifier.FINE.getLeafIndex());
            this.fine = fine;
            return this;
        }
