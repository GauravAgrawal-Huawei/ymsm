...
public class DefaultSupportingNetwork implements SupportingNetwork {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(networkRef, onosYangNodeOperationType);
    }
    ...
    /**
     * Creates an instance of supportingNetwork.
     *
     * @param builderObject builder object of supportingNetwork
     */
    protected DefaultSupportingNetwork(SupportingNetworkBuilder builderObject) {
    ...
    @Override
    public SupportingNetwork processSubtreeFiltering(SupportingNetwork appInstance, boolean isSelectAllSchemaChild) {
        SupportingNetworkBuilder subTreeFilteringResultBuilder = new SupportingNetworkBuilder();
    ...
    private boolean processLeafSubtreeFiltering(SupportingNetwork appInstance, SupportingNetworkBuilder
            subTreeFilteringResultBuilder,
     ...
     */
    protected DefaultSupportingNetwork() {
    }

    /**
     * Returns the attribute SupportingNetworkBuilder.
     *
     * @return value of SupportingNetworkBuilder
     */
    public static SupportingNetworkBuilder builder() {
        return new SupportingNetworkBuilder();
    }
    ...
    /**
     * Represents the builder implementation of supportingNetwork.
     */
    public static class SupportingNetworkBuilder implements SupportingNetwork.SupportingNetworkBuilder {
        ...
        @Override
        public SupportingNetworkBuilder networkRef(Uri networkRef) {
        ...
        @Override
        public SupportingNetworkBuilder onosYangNodeOperationType(OnosYangNodeOperationType
        ...
        @Override
        public SupportingNetworkBuilder selectLeaf(LeafIdentifier leaf) {
        ...
        public SupportingNetwork build() {
            return new DefaultSupportingNetwork(this);
        }

        /**
         * Creates an instance of supportingNetworkBuilder.
         */
