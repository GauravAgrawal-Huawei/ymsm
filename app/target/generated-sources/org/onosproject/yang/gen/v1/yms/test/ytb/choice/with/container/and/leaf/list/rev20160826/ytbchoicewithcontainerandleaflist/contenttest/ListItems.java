 ...
 */
public interface ListItems extends ContentTest  {
    ...
    /**
     * Builder for listItems.
     */
    interface ListItemsBuilder {


        /**
         * Adds to the list of listItems.
         *
         * @param value value of listItems
         * @return builder object of listItems
         */
        ListItemsBuilder addToListItems(byte[] value);
        /**
         * Returns the attribute listItems.
         *
         * @return list of listItems
        ...
        /**
         * Returns the builder object of listItems.
         *
         * @param listItems list of listItems
         * @return builder object of listItems
         */
        ListItemsBuilder listItems(List<byte[]> listItems);
         ...
         */
        ListItemsBuilder onosYangNodeOperationType(OnosYangNodeOperationType onosYangNodeOperationType);
         ...
         */
        ListItemsBuilder selectLeaf(LeafIdentifier leaf);

        /**
         * Builds object of listItems.
         *
         * @return object of listItems.
         */
        ListItems build();
    }
}
