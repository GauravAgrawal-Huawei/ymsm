...
public interface YtbChoiceWithContainerAndLeafList {
    ...
    /**
     * Checks if the passed YtbChoiceWithContainerAndLeafList maps the content match query condition.
     *
     * @param ytbChoiceWithContainerAndLeafList ytbChoiceWithContainerAndLeafList being passed to check for content
            match
     * @param isSelectAllSchemaChild is select all schema child
     * @return match result
     */
    YtbChoiceWithContainerAndLeafList processSubtreeFiltering(YtbChoiceWithContainerAndLeafList
            ytbChoiceWithContainerAndLeafList, boolean isSelectAllSchemaChild);
