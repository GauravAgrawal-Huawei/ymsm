...
/**
 * Abstraction of an entity which represents the functionality of integer8.
 */
public interface Integer8 {
    ...
    /**
     * Checks if the passed Integer8 maps the content match query condition.
     *
     * @param integer8 integer8 being passed to check for content match
     * @param isSelectAllSchemaChild is select all schema child
     * @return match result
     */
    Integer8 processSubtreeFiltering(Integer8 integer8, boolean isSelectAllSchemaChild);
