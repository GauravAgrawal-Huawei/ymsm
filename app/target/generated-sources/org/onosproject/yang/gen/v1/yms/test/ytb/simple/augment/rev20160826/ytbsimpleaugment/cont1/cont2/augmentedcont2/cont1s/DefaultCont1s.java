...
public class DefaultCont1s implements Cont1s {
    ...
    private boolean processLeafSubtreeFiltering(Cont1s appInstance, Cont1sBuilder subTreeFilteringResultBuilder,
    ...
    public static class Cont1sBuilder implements Cont1s.Cont1sBuilder {
        ...
        @Override
        public Cont1sBuilder fine(String fine) {
        ...
        @Override
        public Cont1sBuilder selectLeaf(LeafIdentifier leaf) {
