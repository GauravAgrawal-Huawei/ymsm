...
public interface Invalid extends ContentTest  {
    ...
    interface InvalidBuilder {
        ...
        /**
         * Returns the builder object of createInvalid.
         *
         * @param createInvalid value of createInvalid
         * @return builder object of createInvalid
         */
        InvalidBuilder createInvalid(int createInvalid);
         ...
         */
        InvalidBuilder onosYangNodeOperationType(OnosYangNodeOperationType onosYangNodeOperationType);
         ...
         */
        InvalidBuilder selectLeaf(LeafIdentifier leaf);

        /**
         * Builds object of invalid.
         *
         * @return object of invalid.
         */
        Invalid build();
    }
}
