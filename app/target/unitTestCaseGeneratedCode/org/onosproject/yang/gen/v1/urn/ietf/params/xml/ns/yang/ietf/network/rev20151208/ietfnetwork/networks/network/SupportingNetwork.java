...
public interface SupportingNetwork {
    ...
    interface SupportingNetworkBuilder {
         ...
         */
        SupportingNetworkBuilder networkRef(Uri networkRef);
         ...
         */
        SupportingNetworkBuilder onosYangNodeOperationType(OnosYangNodeOperationType onosYangNodeOperationType);
