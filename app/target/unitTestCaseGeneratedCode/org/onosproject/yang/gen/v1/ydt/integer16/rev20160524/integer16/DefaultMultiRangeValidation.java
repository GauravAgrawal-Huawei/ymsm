...
public class DefaultMultiRangeValidation implements MultiRangeValidation {
    ...
    protected short integer;
    protected int unInteger;
    protected short revInteger;
    protected int revUnInteger;
    ...
    @Override
    public int unInteger() {
        return unInteger;
    }

    @Override
    public short revInteger() {
        return revInteger;
    }

    @Override
    public int revUnInteger() {
        return revUnInteger;
    }
    ...
    public static class MultiRangeValidationBuilder implements MultiRangeValidation.MultiRangeValidationBuilder {
        ...
        @Override
        public MultiRangeValidationBuilder integer(short integer) {
        ...
        @Override
        public MultiRangeValidationBuilder unInteger(int unInteger) {
        ...
        @Override
        public MultiRangeValidationBuilder revInteger(short revInteger) {
        ...
        @Override
        public MultiRangeValidationBuilder revUnInteger(int revUnInteger) {
