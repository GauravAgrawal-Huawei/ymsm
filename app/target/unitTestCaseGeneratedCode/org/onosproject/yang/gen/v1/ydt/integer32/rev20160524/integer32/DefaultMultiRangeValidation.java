...
public class DefaultMultiRangeValidation implements MultiRangeValidation {
    ...
    protected long unInteger;
    protected int revInteger;
    protected long revUnInteger;
    ...
    @Override
    public long unInteger() {
        return unInteger;
    }

    @Override
    public int revInteger() {
        return revInteger;
    }

    @Override
    public long revUnInteger() {
        return revUnInteger;
    }
    ...
    public static class MultiRangeValidationBuilder implements MultiRangeValidation.MultiRangeValidationBuilder {
        ...
        @Override
        public MultiRangeValidationBuilder integer(int integer) {
        ...
        @Override
        public MultiRangeValidationBuilder unInteger(long unInteger) {
        ...
        @Override
        public MultiRangeValidationBuilder revInteger(int revInteger) {
        ...
        @Override
        public MultiRangeValidationBuilder revUnInteger(long revUnInteger) {
