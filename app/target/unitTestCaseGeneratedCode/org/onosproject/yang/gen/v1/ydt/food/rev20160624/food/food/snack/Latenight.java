...
/**
 * Abstraction of an entity which represents the functionality of latenight.
 */
public interface Latenight extends Snack  {
    ...
    /**
     * Builder for latenight.
     */
    interface LatenightBuilder {
         ...
         */
        LatenightBuilder chocolate(ChocolateEnum chocolate);
         ...
         */
        LatenightBuilder selectLeaf(LeafIdentifier leaf);

        /**
         * Builds object of latenight.
         *
         * @return object of latenight.
         */
        Latenight build();
    }
}
