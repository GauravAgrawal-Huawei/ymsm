...
public interface MultiRangeValidation {
    ...
    interface MultiRangeValidationBuilder {
         ...
         */
        MultiRangeValidationBuilder integer(byte integer);
         ...
         */
        MultiRangeValidationBuilder unInteger(short unInteger);
         ...
         */
        MultiRangeValidationBuilder revInteger(byte revInteger);
         ...
         */
        MultiRangeValidationBuilder revUnInteger(short revUnInteger);
