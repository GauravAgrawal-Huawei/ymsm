...
public class DefaultNetwork implements Network {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(networkId, onosYangNodeOperationType, networkTypes, supportingNetwork, node);
    }
    ...
    public static class NetworkBuilder implements Network.NetworkBuilder {
        ...
        @Override
        public NetworkBuilder networkId(Uri networkId) {
        ...
        public NetworkBuilder addToSupportingNetwork(SupportingNetwork value) {
            if (supportingNetwork() == null) {
                supportingNetwork(new ArrayList<>());
            }
