...
package org.onosproject.yang.gen.v1.ydt.integer8.rev20160524.integer8;
...
public class DefaultMultiRangeValidation implements MultiRangeValidation {
    ...
    protected short unInteger;
    protected byte revInteger;
    protected short revUnInteger;
    ...
    @Override
    public short unInteger() {
        return unInteger;
    }

    @Override
    public byte revInteger() {
        return revInteger;
    }

    @Override
    public short revUnInteger() {
        return revUnInteger;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(integer, unInteger, revInteger, revUnInteger, onosYangNodeOperationType);
    }
    ...
    public static class MultiRangeValidationBuilder implements MultiRangeValidation.MultiRangeValidationBuilder {
        ...
        @Override
        public MultiRangeValidationBuilder integer(byte integer) {
        ...
        @Override
        public MultiRangeValidationBuilder unInteger(short unInteger) {
        ...
        @Override
        public MultiRangeValidationBuilder revInteger(byte revInteger) {
        ...
        @Override
        public MultiRangeValidationBuilder revUnInteger(short revUnInteger) {
