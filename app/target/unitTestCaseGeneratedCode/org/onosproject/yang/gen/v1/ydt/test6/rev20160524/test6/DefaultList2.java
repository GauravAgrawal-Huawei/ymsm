...
import org.onosproject.yang.gen.v1.ydt.test6.rev20160524.test6.list2.Cont7;
...
public class DefaultList2 implements List2 {
    ...
    protected List<String> leaflist8;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(leaf5, leaf6, leaf7, leaflist8, onosYangNodeOperationType, cont7);
    }
    ...
    private boolean processChildNodesSubTreeFiltering(List2 appInstance, List2Builder subTreeFilteringResultBuilder,
            Boolean isAnySelectOrContainmentNode, boolean isSelectAllSchemaChild) {
        if (cont7()  != null) {
            isAnySelectOrContainmentNode = true;
    ...
    public static class List2Builder implements List2.List2Builder {
        ...
        @Override
        public List2Builder cont7(Cont7 cont7) {
            this.cont7 = cont7;
            return this;
        }
