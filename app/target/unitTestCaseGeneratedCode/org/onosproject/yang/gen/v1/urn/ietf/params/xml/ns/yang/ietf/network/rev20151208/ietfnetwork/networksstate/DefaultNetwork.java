...
package org.onosproject.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.network.rev20151208.ietfnetwork.networksstate;
...
public class DefaultNetwork implements Network {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(serverProvided, networkRef);
    }
    ...
    public static class NetworkBuilder implements Network.NetworkBuilder {
        ...
        @Override
        public NetworkBuilder networkRef(NetworkId networkRef) {
