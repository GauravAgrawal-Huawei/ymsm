...
public class DefaultAttributes implements Attributes {
    ...
    protected Aigp aigp;
    protected List<UnrecognizedAttributes> unrecognizedAttributes;
    protected List<BgpParameters> bgpParameters;
    ...
    public int hashCode() {
        return Objects
            .hash(onosYangNodeOperationType, origin, multiExitDisc, localPref, aigp, unrecognizedAttributes,
            bgpParameters);
    }
    ...
    public static class AttributesBuilder implements Attributes.AttributesBuilder {
        ...
        public AttributesBuilder addToUnrecognizedAttributes(UnrecognizedAttributes value) {
            if (unrecognizedAttributes() == null) {
                unrecognizedAttributes(new ArrayList<>());
            }
